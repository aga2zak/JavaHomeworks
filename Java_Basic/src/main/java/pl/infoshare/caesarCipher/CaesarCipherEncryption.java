...
public class CaesarCipherEncryption {
    ...
    public static void main (String[] args) {
        ...
        System.out.println("Podaj tekst długości co najmniej 11 znaków do zaszyfrowania.\n Zaszyfrowanych zostanie 11 pierwszych znaków: ");
        ...
        if (inputTextLenght <11){
            ...
            String encryptionInputText = new String(backToChar);
            System.out.println("Zaszyfrowany tekst:  " + encryptionInputText);
        }
    }
}
